...
_.assign(Requester.prototype, /** @lends Requester.prototype */ {
    ...
    request: function (id, request, protocolProfileBehavior, callback) {
        var self = this,
            ...
            /**
             * Helper function to get access to the internal http.agent
             *
             * @param request
             */
            onRequest = function (request) {
                self.emit(REQUEST_INTERNAL_EVENT_BASE + id, request);
            };
        ...
        return requests(request, requestOptions, onStart, onRequest, function (err, res, resBody, debug) {
            if (err) {
